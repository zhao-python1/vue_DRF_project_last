# Generated by Django 2.0.6 on 2020-07-18 21:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('course', '0003_auto_20200716_1706'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_courses', to='sel.Order', verbose_name='订单ID')),
            ],
            options={
                'verbose_name': '订单详情',
